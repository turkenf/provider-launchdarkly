...
func (mg *Project) GetTerraformResourceType() string {
	return "launchdarkly_project"
}

// GetConnectionDetailsMapping for this Project
func (tr *Project) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"environments[*].api_key": "status.atProvider.environments[*].apiKey", "environments[*].client_side_id": "status.atProvider.environments[*].clientSideId", "environments[*].mobile_key": "status.atProvider.environments[*].mobileKey"}
}
